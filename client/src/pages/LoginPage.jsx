      ...
      <section class="mt-6 flex flex-col md:flex-row h-screen items-center">
        <div class="bg-white hidden lg:block w-full md:w-1/2 xl:w-2/3 h-screen">
          <img
            ...
            alt=""
            class="w-full h-[889px] object-cover shadow-[0_3px_10px_rgb(0,0,0,0.2)]"
          />
        </div>
        ...
        flex items-center justify-center">
          <div class="w-full h-100">
            <h1 class="text-xl md:text-2xl font-bold leading-tight -mt-[160px]">
              Log in to your account
            </h1>

            <form class="mt-6" onSubmit={handleLoginSubmit}>
              <div>
            ...
            <div className="py-2 text-center text-gray-500">
              ...
              <Link className=" text-black  " to={"/register"}>
                {" "}<span className="text-indigo-900 font-semibold">Register Now</span>
              </Link>
            </div>
          </div>
        </div>
